...
namespace Samples
{
    ...
    //! [ewrapperimpl]
        ...
        public virtual void historicalData(int reqId, Bar bar)
        {
            ...
            using (StreamWriter w = File.AppendText("init-hist.csv")) { }
            var text = File.ReadAllText("init-hist.csv");
            var time930 = "0";
            var time10 = "0";
            var time11 = "0";
            var time12 = "0";
            ...
            {
                File.WriteAllText("init-hist.csv", time930+ "," + time10 + "," + time11 + "," + time12 + "," + time13 + "," + time14 + "," + time15);
            }
            else
            {
            ...
            if (currentDate.TimeOfDay.Hours == 15)
            {
                ...
                using (StreamWriter sw = File.AppendText("hist-mydata.csv"))
                {
                    sw.WriteLine(currentDate.Date +","+ time930 + "," + time10 + "," + time11 + "," + time12 + "," + time13 + "," + time14 + "," + time15);
            ...
            //using (StreamWriter sw = File.AppendText("hist-mydata.csv"))
            //{
            //    sw.WriteLine(bar.Time + "," + bar.Open + "," + bar.High + "," + bar.Low + "," + bar.Close + "," + bar.Volume + "," + bar.Count + "," + bar.WAP + "," + (bar.Close - bar.Open) * 100 / bar.Open);
            //    // Flush the output to disk
            //    sw.Flush();
            //}
        }
